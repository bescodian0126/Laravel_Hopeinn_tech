...
Route::middleware(['admin'])->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('tree/{username}', 'tree')->name('binary.tree');

        //SSS Search Users
        Route::get('search_users', 'search_users')->name('search');

        //SSS Check username
        Route::get('check_username', 'check_username')->name('check_username');

        //SSS Delete User
        Route::post('delete_user/{id}', 'delete_user')->name('delete');

        //SSS Remove User from plan
        Route::post('remove_from_plan/{id}', 'remove_from_plan')->name('remove_from_plan');
    });
    ...
    Route::controller('TaskController')->prefix('task')->name('task.')->group(function () {
        ...
        Route::get('/task', 'task')->name('add_questions');
        Route::post('/create-question', 'create_question')->name('create_question');
        Route::post('/edit-question', 'edit_question')->name('edit_question');
        Route::post('/delete-question', 'delete_question')->name('delete_question');
        Route::post('/manage-answers', 'manage_answers')->name('manage_answers');
        Route::post('/add_new_answer', 'add_answer')->name('add_new_answer');
        Route::post('/edit-answer', 'edit_answer')->name('edit_answer');
        Route::post('/delete-answer', 'delete_answer')->name('delete_answer');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('delete/{id}', 'task_delete')->name('delete');
        Route::post('save', 'taskSave')->name('save');

        //SSS Task Status Control
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('binary-commission', 'binaryCommission')->name('binary.commission');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::get('matching-bonus', 'matchingBonusIndex')->name('matching.bonus');
        Route::post('matching-bonus', 'matchingBonus')->name('matching.bonus');
    });
