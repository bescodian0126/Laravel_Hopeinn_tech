                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-9">
                                        <div class="file-upload-wrapper" data-text="@lang('Select your file!')">
                                            ...
                                            class="file-upload-field" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx"/>
                                        </div>
                                    </div>
                                    <div class="col-3">
                ...
                $("#fileUploadsContainer").append(`
                    <div class="row">
                        <div class="col-9 mb-3">
                            <div class="file-upload-wrapper" data-text="@lang('Select your file!')"><input type="file" name="attachments[]" id="inputAttachments" class="file-upload-field" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx"/></div>
                        </div>
                        <div class="col-3">
