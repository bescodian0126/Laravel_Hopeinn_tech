                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu p-0">
                                                ...
                                                @endif
                                                <a href="" data-id="{{ $cron->id }}" data-name="{{ $cron->name }}" data-next_run="{{ $formattedDateTime }}" data-cron_schedule_id="{{ $cron->cron_schedule_id }}" class="dropdown-item updateCron"><i class="las la-pen"></i> @lang('Edit')</a>
