            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.package*') }}">
                    <a href="{{ route('admin.package.index') }}" class="nav-link ">
                        <i class="menu-icon las la-compress"></i>
                        <span class="menu-title">@lang('Investment Plans')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.task*', 3) }}">
                        <i class="menu-icon la la-tasks"></i>
                        <span class="menu-title">@lang('Tasks') </span>
                        
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.task*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.task.index') }}">
                                <a href="{{ route('admin.task.index') }}" class="nav-link ">
                                    <i class="menu-icon las la-tasks"></i>
                                    <span class="menu-title">@lang('Tasks')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.task.pending') }} ">
                                <a href="{{ route('admin.task.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Tasks')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.task.approved') }} ">
                                <a href="{{ route('admin.task.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Tasks')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.task.rejected') }} ">
                                <a href="{{ route('admin.task.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Tasks')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.task.log') }} ">
                                <a href="{{ route('admin.task.log') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Tasks Log')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.users*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.paid') }}">
                                <a href="{{ route('admin.users.paid') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Paid Users')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive(['admin.report.referral.commission']) }}">
                                <a href="{{ route('admin.report.referral.commission') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Referral Commission')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive(['admin.report.binary.commission']) }}">
                                <a href="{{ route('admin.report.binary.commission') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.matching.bonus') }}">
                    <a href="{{ route('admin.matching.bonus') }}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('Matching Bonus')</span>
                    </a>
                </li>
