                            ...
                            <tbody>
                                @forelse($userRankings as $userRanking)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary editBtn me-1" data-icon="{{ getImage(getFilePath('userRanking') . '/' . $userRanking->icon, getFileSize('userRanking')) }}" data-ranking="{{ $userRanking }}"><i class="las la-pen"></i>@lang('Edit')</button>
