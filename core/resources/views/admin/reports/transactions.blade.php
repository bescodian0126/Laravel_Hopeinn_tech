            ...
            <div class="card-body">
                <form action="">
                    <div class="d-flex flex-wrap gap-4">
                        ...
                        @if( !request()->routeIs('admin.report.invest') && !request()->routeIs('admin.report.referral.commission') && !request()->routeIs('admin.report.binary.commission') )
                            <div class="flex-grow-1">
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            @forelse($transactions as $trx)
                                <tr>
                                    <td>
                                        <span class="fw-bold">{{ $trx->user->username }}</span>
                                        <br>
                                        <span class="text--small"> <a href="{{ appendQuery('search',$trx->user->username) }}"><span>@</span>{{ $trx->user->username }}</a> </span>
                                    </td>
