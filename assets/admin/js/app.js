...
((className = 'table-responsive') => {
  let dropdown = $(document).find(`.${className} .dropdown`);
  dropdown.on('shown.bs.dropdown', (e) => {
    let currentParent = $(e.currentTarget).closest(`.${className}`);
    currentParent.css("height", currentParent.height() + currentParent.find('.dropdown-menu').outerHeight(true))
  });
  dropdown.on('hidden.bs.dropdown', (e) => {
    let currentParent = $(e.currentTarget).closest(`.${className}`);
    currentParent.css("height", "auto");
  });
})();